...
//import org.cnu.realcoding.weathercrawler.service.RiotService;
...
//        return riotService.getAvailableSummornerNames();
//    }
//
//    @GetMapping("/current-weathers/by-city-name/{cityName}")
//    public CurrentRiot getCurrentWeatherByCityName(@PathVariable String cityName) {
//        return riotService.getCurrentWeatherByCityName(cityName);
//    }
//}
